...
SECRET_KEY = 'django-insecure-xn%ky!sm51s!*e6mkmeymhac=%xeu&kpl*d&637+*#(eq!2kwc'
...
CSRF_TRUSTED_ORIGINS = [
    'https://*.ngrok-free.app',  # If you use the free version
    'https://*.ngrok.io',        # If you use the older domain
    'http://localhost:8000',
    'http://127.0.0.1:8000',]
...
DATABASES = {
    'default': {
        ...
        'NAME': 'BotProject2',                 # database you created in MySQL
        'USER': 'root',                # MySQL username
        'PASSWORD': 'ghandour+123',            # MySQL password
